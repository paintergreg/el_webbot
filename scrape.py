...
def downloadPDF(productID, href):
    ...
    # Prepare the post data.  This will consist of a couple of some
    # hidden input fields and a hard coded string generated by some javascript.
    postData = {}
    ...
    print(productID, productName, sep='-', flush=True)
